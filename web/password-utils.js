if (window.passwordUtils === undefined) {
  ...
  const enabled = () => {
    // not enabled, as all the required libs dont work.
    return false;
  ...
  window.passwordUtils.encryptData = encryptData;
  window.passwordUtils.decryptData = decryptData;
  window.passwordUtils.enabled = enabled;
}
